...
interface LostItemsSectionProps {
  /** Shared found-items list — seeded posts + anything posted from the Found tab. */
  items: FoundItem[];
  /** Signed-in student's id — the only one who can mark a post as received. */
...
export default function LostItemsSection({
  ...
  return (
    <section id="lost-items" className="flex scroll-mt-20 flex-col gap-6">
      ...
      {/* Hint banner */}
      <div className="flex items-center gap-3 rounded-3xl glass-soft p-4 shadow-card sm:p-5">
